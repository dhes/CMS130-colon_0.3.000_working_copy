...
// Configuration
// const sourceDir = '../CMS69-bmi_0.3.000/test-cases';
const sourceDir = path.join(__dirname, "../input/test-cases");
// const destDir = 'input/tests/measure/CMS124FHIRCervicalCancerScreening';
const destDir = path.join(
  __dirname,
  "../input/tests/measure/CMS130FHIRColorectalCancerScreening"
);
